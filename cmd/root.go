...
var RootCmd = &cobra.Command{
	Use:   "php-opcache_exporter",
	Short: "Exports php-fpm opcache metrics for prometheus",
	Long:  `php-opcache_exporter exports prometheus compatible metrics from opcache status for php-fpm.`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".php-opcache_exporter" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".php-opcache_exporter")
	}
